...
export function InterviewContainer({ businessName }: InterviewContainerProps) {
  ...
  if (isLoading && status === null) {
    return (
      <div className="flex flex-col h-full bg-background items-center justify-center p-4 md:p-8">
        ...
        <div className="max-w-md w-full bg-card border border-border rounded-2xl shadow-lg p-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="w-full py-3 px-6 bg-muted text-foreground rounded-xl font-medium hover:bg-muted/80 transition-colors"
            >
              Start Over
            </button>
          </div>
  ...
  return (
    <div className="flex flex-col h-full bg-background items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-2xl h-full max-h-[700px] bg-card border border-border rounded-2xl shadow-lg flex flex-col overflow-hidden">
        {/* Progress bar */}
